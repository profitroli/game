...
public class TestManager11 : MonoBehaviour
{
        ...
        questions = new List<Question>
    {
        new Question
        {
            questionText = "1. Правительство относится к власти:",
            answers = new string[] { "а) законодательной", "б) исполнительной", "в) судебной", "г) абсолютной" },
            correctAnswerIndex = 1 // б) исполнительной
        },
        new Question
        {
            questionText = "2. Основой для создания административного аппарата в славянских княжествах раннефеодального периода стала (-ли):",
            answers = new string[] { "а) дружина князя", "б) мещане", "в) закупы и холопы", "г) бояре и дворяне" },
            correctAnswerIndex = 0 // а) дружина князя
        },
        new Question
        {
            questionText = "3. Вооруженными силами ВКЛ и Речи Посполитой руководил:",
            answers = new string[] { "а) гетман", "б) маршалок", "в) подскарбий", "г) кашталян" },
            correctAnswerIndex = 0 // а) гетман
        },
        new Question
        {
            questionText = "4. В администрации ВКЛ подскарбий земский руководил:",
            answers = new string[] {
                "а) делопроизводством в канцелярии",
                "б) хранилищем с государственной печатью с гербом ВКЛ",
                "в) великокняжеской гвардией и придворной стражей",
                "г) государственными финансовыми делами"
            },
            correctAnswerIndex = 3 // г) государственными финансовыми делами
        },
        new Question
        {
            questionText = "5. Коллегии в Российской империи были заменены на министерства в результате реформы:",
            answers = new string[] { "а) 1802–1803 гг.", "б) 1837–1841 гг.", "в) 1861–1872 гг.", "г) 1874–1888 гг." },
            correctAnswerIndex = 0 // а) 1802–1803 гг.
        },
        new Question
        {
            questionText = "6. Уроженец Минской губернии, первый официальный представитель Российской империи в Японии, известный востоковед и лингвист – это:",
            answers = new string[] { "а) И. Гошкевич", "б) И. Гурко", "в) Э. Гуттен-Чапский", "г) В. Корвин-Круковский" },
            correctAnswerIndex = 0 // а) И. Гошкевич
        },
        new Question
        {
            questionText = "7. В период с 1946 по 1991 г. центральным органом исполнительной власти БССР являлся:",
            answers = new string[] { "а) СНК БССР", "б) Совет Министров БССР", "в) ЦИК БССР", "г) Верховный совет БССР" },
            correctAnswerIndex = 1 // б) Совет Министров БССР
        },
        new Question
        {
            questionText = "8. Правительство Республики Беларусь называется:",
            answers = new string[] { "а) Совет Министров", "б) Кабинет Министров", "в) Государственная Дума", "г) Государственная Рада" },
            correctAnswerIndex = 0 // а) Совет Министров
        },
        new Question
        {
            questionText = "9. Главой Правительства Республики Беларусь является:",
            answers = new string[] { "а) Премьер-министр", "б) Председатель Правительства", "в) Президент Республики Беларусь", "г) Канцлер" },
            correctAnswerIndex = 0 // а) Премьер-министр
        },
        new Question
        {
            questionText = "10. Согласно Конституции БССР 1927 г. СНК БССР являлся органом власти:",
            answers = new string[] { "а) законодательным", "б) судебным", "в) исполнительно-распорядительным", "г) административным" },
            correctAnswerIndex = 2 // в) исполнительно-распорядительным
        }
    };
